        ...
        {loading ? (
          ...
          <div>
            {alerts.map(alert => {
              ...
              const isOverdue = alert.due_date && new Date(alert.due_date) < new Date() && !alert.resolved;
              return (
                <div key={alert.alert_id} className="alert-item" style={{ opacity: alert.resolved ? 0.5 : 1 }}>
